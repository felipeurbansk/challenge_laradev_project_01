                ...
                <div class="col-md-8 col-md-offset-2 text-center">
                    <div class="display-t">
                        <div class="display-tc animate-box" data-animate-effect="fadeIn">
                            ...
                            <p><a class="btn btn-primary btn-lg btn-learn" href="{{ route('web.course') }}">Conhecer o Curso</a> <a
                ...
                <div class="row">
                    @foreach($posts as $post)
                        ...
                        <div class="fh5co-blog animate-box">
                            <a href="{{ route('web.article', $post->uri)  }}">
                                <img
                                    class="img-responsive"
                            ...
                            <div class="blog-text">
                                <h3><a href="{{ route('web.article', $post->uri)  }}" #>{{ substr($post->title, 30) }}</a></h3>
                                <span class="posted_on">{{ date('d/m/Y H:i:s', strtotime($post->created_at)) }}</span>
                                <span class="comment"><a href="">21<i class="icon-speech-bubble"></i></a></span>
                                <p>{{ substr($post->subtitle, 0, 7  0) }}</p>
                                <a href="{{ route('web.article', $post->uri)  }}" class="btn btn-primary">Leia mais</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
